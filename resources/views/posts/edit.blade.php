    ...
    <div class="col-md-8 col-xs-12">
        ...
        <form method="POST" action="{{ route('posts.update', ['id' => $post->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" name="title" id="title" value="{{ old('title', $post->title) }}" placeholder="press input">
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <textarea name="body" class="form-control" id="body" rows="4">{{ old('body', $post->body) }}</textarea>
            </div>
